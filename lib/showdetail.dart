...
class BookDetail extends StatefulWidget {
  ...
  BookDetail(this._idi, {Key key}) : super(key: key); //add also..example this.abc,this...
...
class _BookDetailState extends State<BookDetail> {
  ...
  Future<void> deleteValue(String titleName) async {
    await _firestore.collection('books').doc(titleName).delete().catchError((e) {
      print(e);
    });
  }
  ...
  Stream<QuerySnapshot> getBook(String titleName) {
    ...
    return _firestore.collection('books').where('title', isEqualTo: titleName).snapshots();
  }
}
